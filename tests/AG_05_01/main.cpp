...
void render(const uint32_t& VAO, const Shader& shader, const int32_t text1, const uint32_t text2) {
	...
	proj = glm::perspective(glm::radians(45.0f), 800.0f / 600.0f, 0.1f, 18.0f);
...
int main(int argc, char* argv[])
{
	...
	const Shader shader("../tests/AG_05_01/vertex.vs", "../tests/AG_05_01/fragment.fs");
	uint32_t VBO, EBO; // vertex and element buffer objects
	uint32_t VAO = createVertexData(&VBO, &EBO); // vertex array object

	// textures
	stbi_set_flip_vertically_on_load(true);
	uint32_t text1 = createTexture("../tests/AG_05_01/txt1.jpg");
	uint32_t text2 = createTexture("../tests/AG_05_01/txt2.jpg");
