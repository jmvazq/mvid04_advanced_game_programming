...
void render(const uint32_t& VAO, const Shader& shader_lamp, const Shader& shader_cube, const int32_t text_dif, const uint32_t text_spec) {
	...
	shader_cube.set("light.linear", 0.09f);
...
int main(int argc, char* argv[])
{
	...
	const Shader shader_light("../tests/AG_08_04/light.vs", "../tests/AG_08_04/light.fs");
	const Shader shader_cube("../tests/AG_08_04/cube.vs", "../tests/AG_08_04/cube.fs");
	...
	uint32_t text_dif = createTexture("../tests/AG_08_04/AG07_albedo.png");
	uint32_t text_spec = createTexture("../tests/AG_08_04/AG07_specular.png");
