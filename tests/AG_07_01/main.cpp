...
void render(const uint32_t& VAO, const Shader& shader_lamp, const Shader& shader_cube) {
	...
	shader_cube.set("material.diffuse", 0.54f, 0.89f, 0.63f);
	shader_cube.set("material.specular", 0.316228f, 0.316228f, 0.316228f);
...
int main(int argc, char* argv[])
{
	...
	const Shader shader_light("../tests/AG_07_01/light.vs", "../tests/AG_07_01/light.fs");
	const Shader shader_cube("../tests/AG_07_01/cube.vs", "../tests/AG_07_01/cube.fs");
