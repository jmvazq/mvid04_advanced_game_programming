...
int main(int argc, char* argv[])
{
	...
	const Shader shader_light("../tests/AG_08_03/light.vs", "../tests/AG_08_03/light.fs");
	const Shader shader_cube("../tests/AG_08_03/cube.vs", "../tests/AG_08_03/cube.fs");
	...
	uint32_t text_dif = createTexture("../tests/AG_08_03/AG07_albedo.png");
	uint32_t text_spec = createTexture("../tests/AG_08_03/AG07_specular.png");
